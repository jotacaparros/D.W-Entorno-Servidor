...
<h1>FACTURAS LINEAS PROVEEDORES</h1>
...
<table class="table table-striped table-hover" id="tabla">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="text-align: right; width: 50%;">
                <a href="index.php?c=facturaslineasproveedores&m=editar&id=<?php echo $fila->id; ?>">
                    <button type="button" class="btn btn-success">Editar</button></a>
                <a href="index.php?c=facturaslineasproveedores&m=borrar&id=<?php echo $fila->id; ?>&factura_id=<?php echo $fila->factura_id; ?>">
    ...
    <tfoot>
        <tr>
            <td colspan="5">
                <a href="index.php?c=facturaslineasproveedores&m=nuevo&factura_id=<?php echo $factura_id; ?>">
